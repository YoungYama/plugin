...
$.fn.yzzRectangleDivPager = function(options) {
	var defaults = {
		datas: [ //启动编辑点击事件必须带class：yzz-edit、启动删除点击事件必须带class：yzz-delete
			['http://ww2.sinaimg.cn/mw690/0060tXcFgw1f06d5ziejaj30o016otfp.jpg', '1fghdrg3erfewrg', '<a href="#" class="yzz-pre-view">预览文章</a>', '<a href="#">1标题标题标题</a>', '<a href="javascript:void(0);" class="yzz-edit">编辑</a>', '<a href="#" class="yzz-delete">删除</a>'],
			['http://ww2.sinaimg.cn/mw690/0060tXcFgw1f06d5ziejaj30o016otfp.jpg', '1fghdrg3erfewrg', '<a href="#" class="yzz-pre-view">预览文章</a>', '<a href="#">1标题标题标题</a>', '<a href="javascript:void(0);" class="yzz-edit">编辑</a>', '<a href="#" class="yzz-delete">删除</a>'],
			['http://ww2.sinaimg.cn/mw690/0060tXcFgw1f06d5ziejaj30o016otfp.jpg', '1fghdrg3erfewrg', '<a href="#" class="yzz-pre-view">预览文章</a>', '<a href="#">1标题标题标题</a>', '<a href="javascript:void(0);" class="yzz-edit">编辑</a>', '<a href="#" class="yzz-delete">删除</a>'],
			['http://ww2.sinaimg.cn/mw690/0060tXcFgw1f06d5ziejaj30o016otfp.jpg', '1fghdrg3erfewrg', '<a href="#" class="yzz-pre-view">预览文章</a>', '<a href="#">1标题标题标题</a>', '<a href="javascript:void(0);" class="yzz-edit">编辑</a>', '<a href="#" class="yzz-delete">删除</a>'],
			['http://ww2.sinaimg.cn/mw690/0060tXcFgw1f06d5ziejaj30o016otfp.jpg', '1fghdrg3erfewrg', '<a href="#" class="yzz-pre-view">预览文章</a>', '<a href="#">1标题标题标题</a>', '<a href="javascript:void(0);" class="yzz-edit">编辑</a>', '<a href="#" class="yzz-delete">删除</a>'],
			['http://ww2.sinaimg.cn/mw690/0060tXcFgw1f06d5ziejaj30o016otfp.jpg', '2fghdrg3erfewrg', '<a href="#" class="yzz-pre-view">预览文章</a>', '<a href="#">2标题标题标题</a>', '<a href="javascript:void(0);" class="yzz-edit">编辑</a>', '<a href="#" class="yzz-delete">删除</a>']
		],
		page: {
			'currentPage': 1,
			'pageSize': 10,
	...
	return $(this).each(function() {
		...
		//组装列表数据
		var html = '<div class="yzz-rectangle-articles-div">';
		var article = '';
		var count = 0;
		if(settings.datas.length <= 0) {
			...
			for(var i in settings.datas) { //组装HTML列表
				for(var j in settings.datas[i]) {
					...
					switch(parseInt(j)) {
						case 0:
							article += '<div class="yzz-single-article-div"  style="background-image: url(' + settings.datas[i][j] + ');"><div class="yzz-single-article-main-div"><div class="yzz-single-article-background-div"></div><div class="yzz-single-article-do-div"><input type="checkbox" id="yzz-checkbox-input" class="yzz-checkbox-input" value ="';
							break;
						case 1:
							...
							break;
						case 2:
							article += settings.datas[i][j] + '<div class="yzz-single-article-bottom-div"><div class="yzz-single-article-title-div">';
							break;
						case 3:
						...
						case 4:
							...
							break;
						case 5:
							article += settings.datas[i][j] + '</div></div><div class="yzz-single-article-bottom-background-div"></div></div></div></div>';
							break;
					}
		...
		settings.$this.css({
			'width': settings.$this.find('.yzz-rectangle-articles-div').width(),
			'margin': 'auto'
		});
		//判断在添加批量删除按钮后是否有添加全选复选框
		if(settings.addDeleteButton) {
			if(settings.$this.find('.yzz-rectangle-articles-div input[type=checkbox]').eq(0).length <= 0) {
				alert('请先设置全选复选框');
				return;
			}
		}
		...
		settings.$this.find('.yzz-rectangle-articles-div').after(pagingPlugin);
...
$.fn.yzzRectangleArticlesDivPager = function(options) {
		var defaults = {
			datas: [ //启动编辑点击事件必须带class：yzz-edit、启动删除点击事件必须带class：yzz-delete
				['1fghdrg3erfewrg', '2017-04-02', 'http://ww2.sinaimg.cn/mw690/0060tXcFgw1f06d5ziejaj30o016otfp.jpg', '1111标题标题标题', '<a href="javascript: void(0);" class="yzz-pre-view">预览文章</a>', [
					['1111标题标题标题', 'http://ww2.sinaimg.cn/mw690/0060tXcFgw1f06d5ziejaj30o016otfp.jpg', '<a href="javascript: void(0);" class="yzz-pre-view">预览文章</a>'],
					['标题标题标题', 'http://ww2.sinaimg.cn/mw690/0060tXcFgw1f06d5ziejaj30o016otfp.jpg', '<a href="javascript: void(0);" class="yzz-pre-view">预览文章</a>']
				], '<a href="javascript:void(0);" class="yzz-edit">编辑</a>', '<a href="javascript:void(0);" class="yzz-delete">删除</a>'],
				['2fghdrg3erfewrg', '2017-04-02', 'http://ww2.sinaimg.cn/mw690/0060tXcFgw1f06d5ziejaj30o016otfp.jpg', '标题标题标题', '<a href="javascript: void(0);" class="yzz-pre-view">预览文章</a>', [
					['标题标题标题', 'http://ww2.sinaimg.cn/mw690/0060tXcFgw1f06d5ziejaj30o016otfp.jpg', '<a href="javascript: void(0);" class="yzz-pre-view">预览文章</a>'],
					['标题标题标题', 'http://ww2.sinaimg.cn/mw690/0060tXcFgw1f06d5ziejaj30o016otfp.jpg', '<a href="javascript: void(0);" class="yzz-pre-view">预览文章</a>'],
					['标题标题标题', 'http://ww2.sinaimg.cn/mw690/0060tXcFgw1f06d5ziejaj30o016otfp.jpg', '<a href="javascript: void(0);" class="yzz-pre-view">预览文章</a>']
				], '<a href="javascript:void(0);" class="yzz-edit">编辑</a>', '<a href="javascript:void(0);" class="yzz-delete">删除</a>'],
			...
			chooseAllButton: true,
			$this: $(this),
			fooTitleLength: 10, //父标题最大长度
			childTitleLength: 7, //子标题最大长度
			firstPage: function() {
				alert('firstPage');
			},
			previousPage: function() {
		...
		return $(this).each(function() {
				...
				for(var i in settings.datas) { //组装HTML列表
					for(var j in settings.datas[i]) {
						...
						switch(parseInt(j)) {
							...
							case 1:
								article += settings.datas[i][j] +
									'</span></div><div class="yzz-single-articles-do-div"><div class="yzz-single-articles-div"  style="background-image: url(';
								break;
							case 2:
							...
							case 4:
								...
								break;
							case 5:
								var childArticles = settings.datas[i][j]; //子列表
			...
			settings.$this.find('.yzz-rectangles-articles-div').masonry({
				itemSelector: '.yzz-rectangles-articles-div .yzz-single-articles-main-div',
				columnWidth: 10
			});
			...
			settings.$this.find('.yzz-checkbox-label').click(function() {
				...
				var index = $(this).attr('id');
				$checkbox.eq(index).click();
				var $main = settings.$this.find('.yzz-single-articles-main-div').eq(index);
				if($checkbox.eq(index).prop('checked')) {
					$main.attr('id', 'yes');
					$main.find('.yzz-single-articles-all-backgroud-div').show();
					$main.find('.yzz-pre-view').show();
			...
			//限定标题长度
			var $fooTitles = settings.$this.find('.yzz-single-articles-title-div a'); //父标题
			...
			var $childTitles = settings.$this.find('.yzz-single-articles-title-div a'); //子标题
